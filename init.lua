...
--  Personal preference keymaps
--  Quit insert mode with just two keys
vim.keymap.set('i', 'kj', '<Esc>')
vim.keymap.set('i', 'jk', '<Esc>')

-- center screen on down and up jumps
vim.keymap.set('n', '<C-d>', '<C-d>zz', { desc = 'Center screen after down jump' })
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'Center screen after up jump' })

-- center screen when finding stuff
vim.keymap.set('n', 'n', 'nzzzv', { desc = 'Center screen after next in search' })
vim.keymap.set('n', 'N', 'Nzzzv', { desc = 'Center screen after prev in search' })

-- delete and change buffer
vim.keymap.set('n', '<leader>bd', ':bdelete<CR>', { desc = 'Center screen after next in search' })
vim.keymap.set('n', '<leader>bc', ':bdelete<CR>', { desc = 'Center screen after next in search' })
...
-- When starting inside a godot project directory attach to the global server so godot can open scripts in nvim
-- TODO maybe do this on every directory change?
-- TODO maybe don't use a global pipe, maybe use them locally
local gdpath = vim.fn.getcwd() .. '/.godot'
if vim.uv.fs_stat(gdpath) then
...
require('lazy').setup({
...

  {
    ...
    -- as it said before, this is identical to calling setup with this option
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      -- Tree sitter no longer enables the syntax highlights
      -- Try to enable it for each buffer
